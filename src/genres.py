...
TEXT_GENRES = [
    ...
    # For all MCQ genres, write the COMPLETE MCQ as the text: question stem + four options (A–D).
    # The question and its options should be directly inspired by the Wikipedia excerpt's content.
    ("math MCQ",                   "Write the full MCQ as the text. A mathematics question inspired by the Wikipedia topic (arithmetic, algebra, geometry, or calculus drawn from the topic's facts): precise quantitative stem, four options (A–D), one correct, three distractors based on common computational or conceptual errors."),
    ("history MCQ",                "Write the full MCQ as the text. A history question inspired by the Wikipedia topic: factual or interpretive stem about an event, period, or figure drawn from the excerpt, four options (A–D), distractors from the same era or region to maximise plausibility."),
    ("science MCQ",                "Write the full MCQ as the text. A natural-science question (physics, chemistry, or biology) inspired by the Wikipedia topic: conceptual or numerical stem, four options (A–D), distractors that reflect typical misconceptions or unit/sign errors."),
    ("literature MCQ",             "Write the full MCQ as the text. A question about a literary work, author, or movement connected to the Wikipedia topic: tests comprehension, theme, or device, four options (A–D), distractors use plausible but incorrect interpretations."),
    ("geography MCQ",              "Write the full MCQ as the text. A geography question inspired by the Wikipedia topic: location, physical features, climate, or demographics, four options (A–D), distractors are nearby or commonly confused facts."),
    ("medicine & biology MCQ",     "Write the full MCQ as the text. A biomedical question inspired by the Wikipedia topic (anatomy, physiology, pharmacology, or pathology): four options (A–D), distractors target frequent confusions between related structures or mechanisms."),
    ("philosophy & ethics MCQ",    "Write the full MCQ as the text. A question on a philosophical argument or ethical issue connected to the Wikipedia topic: tests precise understanding of a concept, four options (A–D), distractors are superficially similar positions or misattributions."),
    ("law & civics MCQ",           "Write the full MCQ as the text. A question about a legal principle or civic institution connected to the Wikipedia topic: formal legal register in the stem, four options (A–D), distractors exploit ambiguity between related doctrines."),
    ("economics MCQ",              "Write the full MCQ as the text. An economics question (micro or macro) inspired by the Wikipedia topic: concept, definition, or scenario stem, four options (A–D), distractors reflect common confusions between related terms or effects."),
    ("computer science MCQ",       "Write the full MCQ as the text. A CS question inspired by the Wikipedia topic (algorithms, data structures, programming concepts, or complexity): four options (A–D), distractors use plausible-sounding but wrong outputs, complexities, or definitions."),
    ("general knowledge trivia MCQ","Write the full MCQ as the text. A trivia question about the Wikipedia topic in an accessible register: four options (A–D), distractors are items from the same category that are likely to be confused with the correct answer."),
    ("reading comprehension MCQ",  "Write a short passage (3–5 sentences) inspired by the Wikipedia topic, then a comprehension question testing inference, main idea, or vocabulary-in-context, followed by four options (A–D) drawn exclusively from the passage. The full passage + question + options is the text."),
]